...
function I18N-Status-Param-Process {
	param(
		[string]$___subject
	)
...
# NOTE: Raw printer function. No transaction needed.
...
function I18N-Status-Print-Newline {
	# execute
	I18N-Status-Print plain "`n"
...
function I18N-Status-Print-Plain {
	param(
		[string]$___content
	)
	...
	# execute
	I18N-Status-Print plain "${___content}"

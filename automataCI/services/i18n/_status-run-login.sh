...
I18N_Status_Print_Run_Login_Check() {
        ___subject="$1"
        ...
        *)
                ...
                I18N_Status_Print info "checking ${___subject} login account...\n"
                ;;
        esac
...
I18N_Status_Print_Run_Logout() {
        ...
        *)
                # fallback to default english
                ___subject="$(I18N_Status_Param_Process "${___subject}")"
                I18N_Status_Print info "logging out ${___subject} account...\n"
                ;;
        esac
...
I18N_Status_Print_Run_Logout_Failed() {
        ...
        *)
                # fallback to default english
                I18N_Status_Print error "logout failed.\n\n"
                ;;
        esac

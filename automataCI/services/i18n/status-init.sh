...
I18N_Status_Print_Missing_CONFIG_TOML() {
        ...
        *)
                ...
                I18N_Status_Print error "missing 'CONFIG.toml' file.\n\n"
                ;;
        esac
...
I18N_Status_Print_Unknown_Action() {
        ...
        *)
                # fallback to default english
                I18N_Status_Print error "unknown ACTION.\n\n"
                ;;
        esac
...
I18N_Status_Print_Unsupported_ARCH() {
        ...
        *)
                # fallback to default english
                I18N_Status_Print error "unsupported ARCH.\n\n"
                ;;
        esac
...
I18N_Status_Print_Unsupported_OS() {
        ...
        *)
                # fallback to default english
                I18N_Status_Print error "unsupported OS.\n\n"
                ;;
        esac

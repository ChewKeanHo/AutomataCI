...
I18N_Status_Param_Process() {
        #___subject="$1"


        # execute
        if [ $(STRINGS_Is_Empty "${1}") -ne 0 ]; then
                printf -- "%b" "$1"
                return 0
        fi
...
I18N_Status_Print_Plain() {
        #___content="$1"


        # execute
        I18N_Status_Print plain "$1"

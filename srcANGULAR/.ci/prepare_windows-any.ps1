...
OS-Print-Status info "checking angular availability..."
$__process = ANGULAR-Is-Available
if ($__process -ne 0) {
	OS-Print-Status error "missing angular engines."
	return 1
}
...
# execute
OS-Print-Status info "installing all npm dependencies..."
$__current_path = Get-Location
$null = Set-Location "${env:PROJECT_PATH_ROOT}/${env:PROJECT_ANGULAR}"
$__process = OS-Exec "npm" "install"

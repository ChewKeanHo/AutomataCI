...
function PACKAGE-Assemble-CHOCOLATEY-Content {
	...
	$null = FS-Make-Directory "${_directory}\Data\${env:PROJECT_GO}"
	...
	$__process = FS-Copy-All `
		"${env:PROJECT_PATH_ROOT}\${env:PROJECT_GO}" `
		"${_directory}\Data\${env:PROJECT_GO}"
	if ($__process -ne 0) {
		return 1
	}
...
<package xmlns="http://schemas.microsoft.com/packaging/2015/06/nuspec.xsd">
	...
	<dependencies>
		...
		<dependency id="go" version="1.21.2" />
	</dependencies>
	<files>
